...
export default function Hero() {
  const words = [
    ...
    "Learning MARN Stack",
    "Linux & GitHub for Networking Enthusiast",
  ];

  const [code] = useState(`
const profile = {
    name: 'Abivarman',
    title: 'Full-Stack Developer | Networking Enthusiast | Problem Solver',
    skills: [
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Java lover 🚀 | Networking Enthusiast | Crafting frameworks
